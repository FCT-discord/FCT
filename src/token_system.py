...
def get_main_token() -> str:
    ...
    try:
        ...
        from Token import TOKEN  # type: ignore # pylint: disable=import-outside-toplevel
...
def get_dev_token() -> str:
    ...
    try:
        #  it might not exist that's why we use try catch
        from Token import DEV_TOKEN  # type: ignore # pylint: disable=import-outside-toplevel
